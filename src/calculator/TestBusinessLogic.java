...
public class TestBusinessLogic {
	...
	public static void main(String[] args) {
		...
		boolean flag = test.setOperand1MeasuredValue("1234567890123456");					// Perform the test
		...
		flag = test.setOperand2MeasuredValue("1234560123456789");							// Perform the test
		...
		test.setOperand1MeasuredValue("12345678");
		test.setOperand2MeasuredValue("87654321");
		String answer = test.additionMeasuredValue();
		...
		test.setOperand1MeasuredValue("12345678");
		test.setOperand2MeasuredValue("87654321");
		answer = test.subtractionMeasuredValue();
		...
		test.setOperand1MeasuredValue("12345678");
		test.setOperand2MeasuredValue("87654321");
		answer = test.multiplicationMeasuredValue();
		...
		test.setOperand1MeasuredValue("12345678");
		test.setOperand2MeasuredValue("87654321");
		answer = test.divisionMeasuredValue();
